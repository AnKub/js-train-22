...
throw new Error(`This type button no exist ${type}`);
}
}
// switch (type) {
...
const myIconButton = ButtonFactory.createButton(ButtonFactory.TYPE.ICON, {color: 'red', icon:'/my.png',});
